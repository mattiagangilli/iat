		...
		var iatObj =
		{
			...
			instSecondCombinedTouch:[
				'<div>',
					...
					'<br/>',
					'<p align="left" style="margin-left:5px">',
						'Metti un dito sinistro sull’area verde <b>sinistra</b> per gli elementi di <font color="#336600">leftCategory</font> e di <font color="#0000ff">leftAttribute</font>.<br/>',
						'Metti un dito destro sull’area verde <b>destra</b> per gli elementi di <font color="#336600">rightCategory</font> e di <font color="#0000ff">rightAttribute</font>.<br/>',
						'<br/>',
			...
			instSwitchCategoriesTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						...
						'Metti un dito sinistro sull’area verde <b>sinistra</b> per gli elementi di <font color="#336600">leftCategory</font>.<br/>',
						'Metti un dito destro sull’area verde <b>destra</b> per gli elementi di <font color="#336600">rightCategory</font>.<br/>',
						'Gli elementi appariranno uno alla volta.<br/>',
						'<br/>',
						'Se fai un errore, apparirà una <font color="#ff0000"><b>X</b></font> rossa. Tocca l’altro lato. <u>Procedi il più velocemente possibile</u> mantenendo la precisione.<br/>',
					'</p>',
